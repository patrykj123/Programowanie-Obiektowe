#include "CRegularTriangle.h"
#include <math.h>

const float SQRT3DIV2 = sqrt(3.0) / 2.0;

//********** Private methods ***********
void CRegularTriangle::updateBoundingRect(RECT* newBoundingRect)
{
...
//********** Protected methods ***********
void CRegularTriangle::beforeBoundingRectChange(RECT* newBoundingRect)
{
