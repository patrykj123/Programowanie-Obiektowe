...
{
    aBoundingRect.left = mBoundingRect.left;
    aBoundingRect.right = mBoundingRect.right;
    aBoundingRect.top = mBoundingRect.top;
    aBoundingRect.bottom = mBoundingRect.bottom;
}
